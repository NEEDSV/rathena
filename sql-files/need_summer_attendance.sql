...
-- Import into the main map-server database before enabling the provider.
...
CREATE TABLE IF NOT EXISTS `need_summer_attendance_reward_outbox` (
  ...
  `status` tinyint unsigned NOT NULL DEFAULT 0 COMMENT '0=pending,1=processing,2=delivered,3=failed',
