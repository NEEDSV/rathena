...
static void clif_changemap_hook(const map_session_data& sd)
{
	skill_clear_animation(const_cast<map_session_data*>(&sd));
}
...
static int clif_skill_damage_hook(block_list* src, block_list* dst, t_tick tick, int32 sdelay, int32 ddelay, int64 sdamage, int16 div, uint16 skill_id, uint16 skill_lv, enum e_damage_type type)  
{  
...
void clif_skill_damage( const block_list& src, const block_list& dst, t_tick tick, int32 sdelay, int32 ddelay, int64 sdamage, int16 div, uint16 skill_id, uint16 skill_lv, e_damage_type type ){
	...
	clif_skill_damage_hook(const_cast<block_list*>(&src), const_cast<block_list*>(&dst), tick, sdelay, ddelay, sdamage, div, skill_id, skill_lv, type);
