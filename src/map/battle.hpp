...
struct Battle_Config
{
	...
	int32 cash_vending_tax;
	int32 cash_vending_tax_min;
...
// eAthena additions
	...
	int32 need_macro_hunt_min_kill_count;
	int32 need_macro_hunt_force_kill_count;
	int32 need_macro_hunt_force_time;
	int32 need_macro_hunt_debug;
	int32 need_jf_pattern_enable;
	...
	int32 need_jf_decay_score;
	int32 need_jf_decay_interval;
	int32 need_jf_captcha_success_score;
	int32 need_jf_penalty_reset_score;
	int32 need_jf_autoloot_penalty1;
	int32 need_jf_autoloot_penalty2;
	int32 need_jf_autoloot_penalty3;
	int32 need_jf_penalty_count_reset;
	int32 need_jf_pattern_debug;
	int32 need_world_drop_enable;
	int32 need_world_drop_debug;
	...
	int32 need_world_drop_tier1_item_id;
	int32 need_world_drop_tier1_base_rate;
	int32 need_world_drop_tier1_rate_per_level;
	int32 need_world_drop_tier1_amount;
	int32 need_world_drop_tier2_enable;
	int32 need_world_drop_tier2_min_level;
	int32 need_world_drop_tier2_max_level;
	int32 need_world_drop_tier2_item_id;
	int32 need_world_drop_tier2_base_rate;
	int32 need_world_drop_tier2_rate_per_level;
	int32 need_world_drop_tier2_amount;
	int32 need_world_drop_tier3_enable;
	int32 need_world_drop_tier3_min_level;
	int32 need_world_drop_tier3_max_level;
	int32 need_world_drop_tier3_item_id;
	int32 need_world_drop_tier3_base_rate;
	int32 need_world_drop_tier3_rate_per_level;
	int32 need_world_drop_tier3_amount;
	int32 need_world_drop_tier4_enable;
	int32 need_world_drop_tier4_min_level;
	int32 need_world_drop_tier4_max_level;
	int32 need_world_drop_tier4_item_id;
	int32 need_world_drop_tier4_base_rate;
	int32 need_world_drop_tier4_rate_per_level;
	int32 need_world_drop_tier4_amount;
	int32 need_world_drop_bonus_enable;
	int32 need_world_drop_bonus_min_level;
	int32 need_world_drop_bonus_max_level;
	int32 need_world_drop_bonus_item_id;
	int32 need_world_drop_bonus_rate;
	int32 need_world_drop_bonus_amount;
	int32 need_world_drop_mvp_enable;
	int32 need_world_drop_mvp_item_id;
	int32 need_world_drop_mvp_rate;
	int32 need_world_drop_mvp_amount;
	int32 need_world_drop_mvp_allow_normal_drop;
	int32 need_world_drop_exclude_boss_mode;
	int32 need_world_drop_event_mode;
	int32 need_world_drop_event_rate_multiplier;
