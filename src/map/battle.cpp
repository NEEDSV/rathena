...
int32 battle_check_target( const block_list* src, const block_list* target, int32 flag )
{
	...
	{ //Check rivalry settings.
		...
		if( flag&(BCT_GUILD|BCT_ENEMY) )
		{
			...
			if( !(mapdata->getMapFlag(MF_PVP) && mapdata->getMapFlag(MF_PVP_NOGUILD)) &&
				!(mapdata_flag_gvg(mapdata) && mapdata->getMapFlag(MF_GVG_NOGUILD)) &&
...
//	{ "mob_skill_use",                      &battle_config.mob_skill_use,                   1,      0,      1,              }, //Deprecated
	...
	{ "enable_cash_vending",                &battle_config.enable_cash_vending,             1,      0,      1,              },
	{ "cash_vending_autotrade",             &battle_config.cash_vending_autotrade,          1,      0,      1,              },
	{ "cash_vending_same_account",           &battle_config.cash_vending_same_account,       0,      0,      1,              },
	{ "cash_vending_tax",                    &battle_config.cash_vending_tax,              500,      0,      10000,          },
	{ "cash_vending_tax_min",                &battle_config.cash_vending_tax_min,          10000,      0,      MAX_CASHPOINT,  },
...
// rAthena
	...
	{ "edp_keep_on_weapon_switch",          &battle_config.edp_keep_on_weapon_switch,       0,      0,      1,              },
	...
	{ "feature.need_summer_attendance",     &battle_config.feature_need_summer_attendance,  0,      0,      1,              },
	{ "need_summer.attendance_start_date",  &battle_config.need_summer_attendance_start_date, 20260815, 20000101, 20991231, },
	{ "need_summer.attendance_end_date",    &battle_config.need_summer_attendance_end_date, 20260911, 20000101, 20991231,  },
	{ "need_summer.attendance_required_seconds", &battle_config.need_summer_attendance_required_seconds, 1800, 1, 86400, },
	{ "need_summer.attendance_max_claims",  &battle_config.need_summer_attendance_max_claims, 20, 1, 20,                   },
	...
	{ "need_jf_pattern_enable",             &battle_config.need_jf_pattern_enable,          1,      0,      1,              },
